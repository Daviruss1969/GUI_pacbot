    ...
    <div id = "container">
        ...
        <div id="nav_panel">
            <div id="rotate">
                ...
                <div id="bottom" class="nav_btn" title='Rotate up'>
                    <small>▼</small>
                </div>
                <div id="right" class="nav_btn" title='Rotate right'>
                    <small>▶</small>
                </div>
                <div id="left" class="nav_btn" title='Rotate down'>
                    <small>◀</small>
                </div>
                <div id="middle" class="nav_btn">H</div>
            </div>

            <div id="zoom_panel">
                <div id="zoom_in" class="nav_btn" title='Zoom out'>
                    <b>+</b>
                </div>
                <div id="zoom_out" class="nav_btn" title='Zoom in'>
                    <b>-</b>
                </div>
            </div>

            <div id="move_panel">
                <div id="move_left" class="nav_btn" title='Move left'>
                    <b>◀</b>
                </div>
                <div id="move_right" class="nav_btn" title='Move right'>
                    <b>▶</b>
                </div>
            </div>
...
<script>
import TableLego from "./TableLego.vue"
export default {
...
#rotate {
    ...
    background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #303840), color-stop(1, #202224));
    background: -ms-linear-gradient(bottom, #303840, #202224);
    background: -moz-linear-gradient(center bottom, #303840 0, #202224 100%);
    -webkit-user-select: none;
    left: 0;
    right: 0;
    width: 60px;
